 ...
 /**
  * rem自适应布局计算,兼容UC竖屏转横屏出现的BUG,自定义设计稿的宽度：designWidth
  * @param {string} designWidth(设计稿实际宽度) maxWidth(制作稿最大宽度)
  * 调用方法remSize(750, 750) 以750的设计稿为例，如果是640的设计感，则是remSize(640, 750)
  */
 function remSize(designWidth, maxWidth) {
   var doc = document,
     win = window,
